...
@XmlRootElement(name = "updateFileStatusAsyncResponse")
public class UpdateFileStatusAsyncResponse
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof UpdateFileStatusAsyncResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final UpdateFileStatusAsyncResponse that = ((UpdateFileStatusAsyncResponse) object);
        {
            boolean lhsSuccess;
