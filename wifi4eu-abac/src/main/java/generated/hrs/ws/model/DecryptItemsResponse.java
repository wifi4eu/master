...
@XmlRootElement(name = "decryptItemsResponse")
public class DecryptItemsResponse
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DecryptItemsResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DecryptItemsResponse that = ((DecryptItemsResponse) object);
        {
            boolean lhsSuccess;
