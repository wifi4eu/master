...
/**
 * Request for updating an existing file via lanching an asynchronous operation.
 * 
 * <p>Java class for UpdateFileStatusAsyncRequest complex type.
 * 
...
@XmlType(name = "UpdateFileStatusAsyncRequest", propOrder = {
    "fileId",
    "status"
})
public class UpdateFileStatusAsyncRequest
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof UpdateFileStatusAsyncRequest)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final UpdateFileStatusAsyncRequest that = ((UpdateFileStatusAsyncRequest) object);
        {
            String lhsFileId;
