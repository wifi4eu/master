 ...
 *         &lt;element name="procedureId" type="{http://www.w3.org/2001/XMLSchema}int"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "applyProcedure")
    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ApplyProcedure)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ApplyProcedure that = ((ApplyProcedure) object);
        {
            Header lhsHeader;
