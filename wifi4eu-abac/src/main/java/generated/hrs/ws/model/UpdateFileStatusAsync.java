 ...
 *         &lt;element name="request" type="{http://ec.europa.eu/sg/hrs/types}UpdateFileStatusAsyncRequest"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "updateFileStatusAsync")
public class UpdateFileStatusAsync
    implements Equals, HashCode, ToString
{
    ...
    @XmlElement(required = true)
    protected UpdateFileStatusAsyncRequest request;
     ...
     * @return
     *     possible object is
     *     {@link UpdateFileStatusAsyncRequest }
     *     
     */
    public UpdateFileStatusAsyncRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(UpdateFileStatusAsyncRequest value) {
        this.request = value;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof UpdateFileStatusAsync)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final UpdateFileStatusAsync that = ((UpdateFileStatusAsync) object);
        {
            Header lhsHeader;
        ...
        {
            UpdateFileStatusAsyncRequest lhsRequest;
            lhsRequest = this.getRequest();
            UpdateFileStatusAsyncRequest rhsRequest;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            UpdateFileStatusAsyncRequest theRequest;
