...
@XmlRootElement(name = "registerDocumentById")
public class RegisterDocumentById
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof RegisterDocumentById)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final RegisterDocumentById that = ((RegisterDocumentById) object);
        {
            Header lhsHeader;
