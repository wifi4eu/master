...
@XmlRootElement(name = "deleteDocumentNotificationsResponse")
public class DeleteDocumentNotificationsResponse
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DeleteDocumentNotificationsResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DeleteDocumentNotificationsResponse that = ((DeleteDocumentNotificationsResponse) object);
        {
            boolean lhsSuccess;
