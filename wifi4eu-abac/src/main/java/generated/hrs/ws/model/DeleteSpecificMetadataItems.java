 ...
 *         &lt;element name="specificMetadataItems" type="{http://ec.europa.eu/sg/hrs/types}SpecificMetadataItemsToDelete"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "deleteSpecificMetadataItems")
public class DeleteSpecificMetadataItems
    implements Equals, HashCode, ToString
{
    ...
    @XmlElement(required = true)
    protected SpecificMetadataItemsToDelete specificMetadataItems;
     ...
     * @return
     *     possible object is
     *     {@link SpecificMetadataItemsToDelete }
     *     
     */
    public SpecificMetadataItemsToDelete getSpecificMetadataItems() {
     ...
     *     
     */
    public void setSpecificMetadataItems(SpecificMetadataItemsToDelete value) {
        this.specificMetadataItems = value;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DeleteSpecificMetadataItems)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DeleteSpecificMetadataItems that = ((DeleteSpecificMetadataItems) object);
        {
            Header lhsHeader;
        ...
        {
            SpecificMetadataItemsToDelete lhsSpecificMetadataItems;
            lhsSpecificMetadataItems = this.getSpecificMetadataItems();
            SpecificMetadataItemsToDelete rhsSpecificMetadataItems;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            SpecificMetadataItemsToDelete theSpecificMetadataItems;
