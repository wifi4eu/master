...
@XmlRootElement(name = "cancelItemCheckout")
public class CancelItemCheckout
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CancelItemCheckout)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CancelItemCheckout that = ((CancelItemCheckout) object);
        {
            Header lhsHeader;
