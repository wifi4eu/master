 ...
 *         &lt;element name="request" type="{http://ec.europa.eu/sg/hrs/types}UnlinkDocumentsRequest"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "unlinkDocuments")
public class UnlinkDocuments
    implements Equals, HashCode, ToString
{
    ...
    @XmlElement(required = true)
    protected UnlinkDocumentsRequest request;
     ...
     * @return
     *     possible object is
     *     {@link UnlinkDocumentsRequest }
     *     
     */
    public UnlinkDocumentsRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(UnlinkDocumentsRequest value) {
        this.request = value;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof UnlinkDocuments)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final UnlinkDocuments that = ((UnlinkDocuments) object);
        {
            Header lhsHeader;
        ...
        {
            UnlinkDocumentsRequest lhsRequest;
            lhsRequest = this.getRequest();
            UnlinkDocumentsRequest rhsRequest;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            UnlinkDocumentsRequest theRequest;
