...
@XmlRootElement(name = "revokeExternalizationResponse")
public class RevokeExternalizationResponse
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof RevokeExternalizationResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final RevokeExternalizationResponse that = ((RevokeExternalizationResponse) object);
        {
            boolean lhsSuccess;
