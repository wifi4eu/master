 ...
 *         &lt;element name="request" type="{http://ec.europa.eu/sg/hrs/types}AddExternalSignatureRequest"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "addExternalSignature")
public class AddExternalSignature
    implements Equals, HashCode, ToString
{
    ...
    @XmlElement(required = true)
    protected AddExternalSignatureRequest request;
     ...
     * @return
     *     possible object is
     *     {@link AddExternalSignatureRequest }
     *     
     */
    public AddExternalSignatureRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(AddExternalSignatureRequest value) {
        this.request = value;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof AddExternalSignature)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final AddExternalSignature that = ((AddExternalSignature) object);
        {
            Header lhsHeader;
        ...
        {
            AddExternalSignatureRequest lhsRequest;
            lhsRequest = this.getRequest();
            AddExternalSignatureRequest rhsRequest;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            AddExternalSignatureRequest theRequest;
