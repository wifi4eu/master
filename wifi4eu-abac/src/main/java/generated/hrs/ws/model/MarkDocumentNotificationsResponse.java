...
@XmlRootElement(name = "markDocumentNotificationsResponse")
public class MarkDocumentNotificationsResponse
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof MarkDocumentNotificationsResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final MarkDocumentNotificationsResponse that = ((MarkDocumentNotificationsResponse) object);
        {
            boolean lhsSuccess;
