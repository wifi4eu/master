 ...
 *         &lt;element name="specificMetadataItems" type="{http://ec.europa.eu/sg/hrs/types}SpecificMetadataItemsToAdd"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "createSpecificMetadataItems")
public class CreateSpecificMetadataItems
    implements Equals, HashCode, ToString
{
    ...
    @XmlElement(required = true)
    protected SpecificMetadataItemsToAdd specificMetadataItems;
     ...
     * @return
     *     possible object is
     *     {@link SpecificMetadataItemsToAdd }
     *     
     */
    public SpecificMetadataItemsToAdd getSpecificMetadataItems() {
     ...
     *     
     */
    public void setSpecificMetadataItems(SpecificMetadataItemsToAdd value) {
        this.specificMetadataItems = value;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CreateSpecificMetadataItems)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CreateSpecificMetadataItems that = ((CreateSpecificMetadataItems) object);
        {
            Header lhsHeader;
        ...
        {
            SpecificMetadataItemsToAdd lhsSpecificMetadataItems;
            lhsSpecificMetadataItems = this.getSpecificMetadataItems();
            SpecificMetadataItemsToAdd rhsSpecificMetadataItems;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            SpecificMetadataItemsToAdd theSpecificMetadataItems;
