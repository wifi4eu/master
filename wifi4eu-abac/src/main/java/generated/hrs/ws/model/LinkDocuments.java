 ...
 *         &lt;element name="request" type="{http://ec.europa.eu/sg/hrs/types}LinkDocumentsRequest"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "linkDocuments")
    ...
    implements Equals, HashCode, ToString
{
    ...
    @XmlElement(required = true)
    protected LinkDocumentsRequest request;
     ...
     * @return
     *     possible object is
     *     {@link LinkDocumentsRequest }
     *     
     */
    public LinkDocumentsRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(LinkDocumentsRequest value) {
        this.request = value;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof LinkDocuments)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final LinkDocuments that = ((LinkDocuments) object);
        {
            Header lhsHeader;
        ...
        {
            LinkDocumentsRequest lhsRequest;
            lhsRequest = this.getRequest();
            LinkDocumentsRequest rhsRequest;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            LinkDocumentsRequest theRequest;
