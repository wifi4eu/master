...
@XmlRootElement(name = "updateSpecificMetadataItemsResponse")
public class UpdateSpecificMetadataItemsResponse
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof UpdateSpecificMetadataItemsResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final UpdateSpecificMetadataItemsResponse that = ((UpdateSpecificMetadataItemsResponse) object);
        {
            boolean lhsSuccess;
