 ...
 *         &lt;element name="specificMetadata" type="{http://ec.europa.eu/sg/hrs/types}SpecificMetadata"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "createOrUpdateSpecificMetadata")
public class CreateOrUpdateSpecificMetadata
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CreateOrUpdateSpecificMetadata)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CreateOrUpdateSpecificMetadata that = ((CreateOrUpdateSpecificMetadata) object);
        {
            Header lhsHeader;
