 ...
 *         &lt;element name="request" type="{http://ec.europa.eu/sg/hrs/types}GetUpdateFileStatusAsyncResultRequest"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "getUpdateFileStatusAsyncResult")
public class GetUpdateFileStatusAsyncResult
    implements Equals, HashCode, ToString
{
    ...
    @XmlElement(required = true)
    protected GetUpdateFileStatusAsyncResultRequest request;
     ...
     * @return
     *     possible object is
     *     {@link GetUpdateFileStatusAsyncResultRequest }
     *     
     */
    public GetUpdateFileStatusAsyncResultRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(GetUpdateFileStatusAsyncResultRequest value) {
        this.request = value;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetUpdateFileStatusAsyncResult)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GetUpdateFileStatusAsyncResult that = ((GetUpdateFileStatusAsyncResult) object);
        {
            Header lhsHeader;
        ...
        {
            GetUpdateFileStatusAsyncResultRequest lhsRequest;
            lhsRequest = this.getRequest();
            GetUpdateFileStatusAsyncResultRequest rhsRequest;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            GetUpdateFileStatusAsyncResultRequest theRequest;
