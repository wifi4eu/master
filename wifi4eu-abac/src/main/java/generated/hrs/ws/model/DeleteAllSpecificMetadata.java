...
@XmlRootElement(name = "deleteAllSpecificMetadata")
public class DeleteAllSpecificMetadata
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DeleteAllSpecificMetadata)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DeleteAllSpecificMetadata that = ((DeleteAllSpecificMetadata) object);
        {
            Header lhsHeader;
