...
@XmlRootElement(name = "deleteSpecificMetadataItemsResponse")
public class DeleteSpecificMetadataItemsResponse
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DeleteSpecificMetadataItemsResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DeleteSpecificMetadataItemsResponse that = ((DeleteSpecificMetadataItemsResponse) object);
        {
            boolean lhsSuccess;
