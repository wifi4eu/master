 ...
 *         &lt;element name="request" type="{http://ec.europa.eu/sg/hrs/types}UpdateFileRequest"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "updateFile")
    ...
    implements Equals, HashCode, ToString
{
    ...
    @XmlElement(required = true)
    protected UpdateFileRequest request;
     ...
     * @return
     *     possible object is
     *     {@link UpdateFileRequest }
     *     
     */
    public UpdateFileRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(UpdateFileRequest value) {
        this.request = value;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof UpdateFile)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final UpdateFile that = ((UpdateFile) object);
        {
            Header lhsHeader;
        ...
        {
            UpdateFileRequest lhsRequest;
            lhsRequest = this.getRequest();
            UpdateFileRequest rhsRequest;
