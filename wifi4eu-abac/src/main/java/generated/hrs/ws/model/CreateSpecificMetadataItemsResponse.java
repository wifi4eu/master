...
@XmlRootElement(name = "createSpecificMetadataItemsResponse")
public class CreateSpecificMetadataItemsResponse
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CreateSpecificMetadataItemsResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CreateSpecificMetadataItemsResponse that = ((CreateSpecificMetadataItemsResponse) object);
        {
