 ...
 *       &lt;sequence>
 *         &lt;element name="result" type="{http://ec.europa.eu/sg/hrs/types}OperationResponse"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "unfileDocumentResponse")
public class UnfileDocumentResponse
    implements Equals, HashCode, ToString
{
     ...
     *     
     */
    public void setResult(OperationResponse value) {
        this.result = value;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof UnfileDocumentResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final UnfileDocumentResponse that = ((UnfileDocumentResponse) object);
        {
            OperationResponse lhsResult;
            lhsResult = this.getResult();
            OperationResponse rhsResult;
