...
@XmlRootElement(name = "unlinkDocumentsResponse")
public class UnlinkDocumentsResponse
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof UnlinkDocumentsResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final UnlinkDocumentsResponse that = ((UnlinkDocumentsResponse) object);
        {
            boolean lhsSuccess;
