 ...
 *         &lt;element name="request" type="{http://ec.europa.eu/sg/hrs/types}DocumentUpdateRequest"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    implements Equals, HashCode, ToString
{
    ...
    @XmlElement(required = true)
    protected DocumentUpdateRequest request;
     ...
     *     
     */
    public void setRequest(DocumentUpdateRequest value) {
        this.request = value;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof UpdateDocument)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final UpdateDocument that = ((UpdateDocument) object);
        {
            Header lhsHeader;
        ...
        {
            DocumentUpdateRequest lhsRequest;
            lhsRequest = this.getRequest();
            DocumentUpdateRequest rhsRequest;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            DocumentUpdateRequest theRequest;
