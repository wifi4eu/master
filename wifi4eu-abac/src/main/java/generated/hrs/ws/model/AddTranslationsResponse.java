...
@XmlRootElement(name = "addTranslationsResponse")
public class AddTranslationsResponse
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof AddTranslationsResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final AddTranslationsResponse that = ((AddTranslationsResponse) object);
        {
            boolean lhsSuccess;
