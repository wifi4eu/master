...
@XmlRootElement(name = "createOrUpdateSpecificMetadataResponse")
public class CreateOrUpdateSpecificMetadataResponse
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CreateOrUpdateSpecificMetadataResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CreateOrUpdateSpecificMetadataResponse that = ((CreateOrUpdateSpecificMetadataResponse) object);
        {
            boolean lhsSuccess;
