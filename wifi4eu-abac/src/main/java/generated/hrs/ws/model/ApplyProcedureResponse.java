...
@XmlRootElement(name = "applyProcedureResponse")
public class ApplyProcedureResponse
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ApplyProcedureResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ApplyProcedureResponse that = ((ApplyProcedureResponse) object);
        {
            boolean lhsSuccess;
