...
/**
 * Request for the operation registerDocument
 * 
 * <p>Java class for DocumentRegistrationRequest complex type.
 * 
 ...
 *         &lt;element name="senders" type="{http://ec.europa.eu/sg/hrs/types}SendersToAdd"/>
 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element name="uploadedItem" type="{http://ec.europa.eu/sg/hrs/types}UploadedItemToAdd" maxOccurs="unbounded"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
    ...
    implements Equals, HashCode, ToString
{
    ...
    protected DocumentRegistrationRequest.Items items;
     ...
     * @return
     *     possible object is
     *     {@link DocumentRegistrationRequest.Items }
     *     
     */
    public DocumentRegistrationRequest.Items getItems() {
        return items;
    }
     ...
     *     
     */
    public void setItems(DocumentRegistrationRequest.Items value) {
        this.items = value;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DocumentRegistrationRequest)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DocumentRegistrationRequest that = ((DocumentRegistrationRequest) object);
        {
            String lhsTitle;
        ...
        {
            DocumentRegistrationRequest.Items lhsItems;
            lhsItems = this.getItems();
            DocumentRegistrationRequest.Items rhsItems;
        ...
        {
            Boolean lhsSendNotifications;
            lhsSendNotifications = this.isSendNotifications();
            Boolean rhsSendNotifications;
            rhsSendNotifications = that.isSendNotifications();
            if (!strategy.equals(LocatorUtils.property(thisLocator, "sendNotifications", lhsSendNotifications), LocatorUtils.property(thatLocator, "sendNotifications", rhsSendNotifications), lhsSendNotifications, rhsSendNotifications)) {
                return false;
            }
        }
        {
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            DocumentRegistrationRequest.Items theItems;
        ...
        {
            Boolean theSendNotifications;
            theSendNotifications = this.isSendNotifications();
            strategy.appendField(locator, this, "sendNotifications", buffer, theSendNotifications);
        }
        {
            String theFileId;
    ...
    public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
        ...
        }
        {
            Boolean theSendNotifications;
            theSendNotifications = this.isSendNotifications();
            currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "sendNotifications", theSendNotifications), currentHashCode, theSendNotifications);
        }
        {
            String theFileId;
            theFileId = this.getFileId();
        ...
        implements Equals, HashCode, ToString
    {
        ...
        @XmlElement(required = true)
        protected List<UploadedItemToAdd> uploadedItem;

        /**
         * Gets the value of the uploadedItem property.
         * 
         * <p>
         * This accessor method returns a reference to the live list,
         * not a snapshot. Therefore any modification you make to the
         * returned list will be present inside the JAXB object.
         * This is why there is not a <CODE>set</CODE> method for the uploadedItem property.
         * 
         * <p>
         * For example, to add a new item, do as follows:
         * <pre>
         *    getUploadedItem().add(newItem);
         * </pre>
         * 
         * 
         * <p>
         ...
         * 
         */
        public List<UploadedItemToAdd> getUploadedItem() {
            if (uploadedItem == null) {
                uploadedItem = new ArrayList<UploadedItemToAdd>();
            }
            return this.uploadedItem;
        }

        public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
            if (!(object instanceof DocumentRegistrationRequest.Items)) {
                return false;
            }
            if (this == object) {
                return true;
            }
            final DocumentRegistrationRequest.Items that = ((DocumentRegistrationRequest.Items) object);
            {
                List<UploadedItemToAdd> lhsUploadedItem;
                lhsUploadedItem = (((this.uploadedItem!= null)&&(!this.uploadedItem.isEmpty()))?this.getUploadedItem():null);
                List<UploadedItemToAdd> rhsUploadedItem;
                rhsUploadedItem = (((that.uploadedItem!= null)&&(!that.uploadedItem.isEmpty()))?that.getUploadedItem():null);
                if (!strategy.equals(LocatorUtils.property(thisLocator, "uploadedItem", lhsUploadedItem), LocatorUtils.property(thatLocator, "uploadedItem", rhsUploadedItem), lhsUploadedItem, rhsUploadedItem)) {
                    return false;
                }
            }
            return true;
        ...
        public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
            {
                List<UploadedItemToAdd> theUploadedItem;
                theUploadedItem = (((this.uploadedItem!= null)&&(!this.uploadedItem.isEmpty()))?this.getUploadedItem():null);
                strategy.appendField(locator, this, "uploadedItem", buffer, theUploadedItem);
            }
            return buffer;
        }
        ...
        public int hashCode(ObjectLocator locator, HashCodeStrategy strategy) {
            int currentHashCode = 1;
            {
                List<UploadedItemToAdd> theUploadedItem;
                theUploadedItem = (((this.uploadedItem!= null)&&(!this.uploadedItem.isEmpty()))?this.getUploadedItem():null);
                currentHashCode = strategy.hashCode(LocatorUtils.property(locator, "uploadedItem", theUploadedItem), currentHashCode, theUploadedItem);
            }
            return currentHashCode;
        }
