...
@XmlRootElement(name = "updateFileStatusResponse")
    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof UpdateFileStatusResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final UpdateFileStatusResponse that = ((UpdateFileStatusResponse) object);
        {
            boolean lhsSuccess;
