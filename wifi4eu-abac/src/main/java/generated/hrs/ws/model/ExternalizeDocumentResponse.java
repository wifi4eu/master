...
@XmlRootElement(name = "externalizeDocumentResponse")
public class ExternalizeDocumentResponse
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ExternalizeDocumentResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final ExternalizeDocumentResponse that = ((ExternalizeDocumentResponse) object);
        {
            boolean lhsSuccess;
