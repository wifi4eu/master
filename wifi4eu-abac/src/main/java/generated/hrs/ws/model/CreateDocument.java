 ...
 *         &lt;element name="request" type="{http://ec.europa.eu/sg/hrs/types}DocumentCreationRequest"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    implements Equals, HashCode, ToString
{
    ...
    @XmlElement(required = true)
    protected DocumentCreationRequest request;
     ...
     *     
     */
    public void setRequest(DocumentCreationRequest value) {
        this.request = value;
    }
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        final CreateDocument that = ((CreateDocument) object);
        {
            Header lhsHeader;
        ...
        {
            DocumentCreationRequest lhsRequest;
            lhsRequest = this.getRequest();
            DocumentCreationRequest rhsRequest;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            DocumentCreationRequest theRequest;
