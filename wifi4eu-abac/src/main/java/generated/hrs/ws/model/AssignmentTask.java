...
/**
 * A task used in a Assignment workflow
 * 
 * <p>Java class for AssignmentTask complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AssignmentTask">
 *   &lt;complexContent>
...
@XmlType(name = "AssignmentTask", propOrder = {
    "code"
})
    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof AssignmentTask)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final AssignmentTask that = ((AssignmentTask) object);
        {
            String lhsCode;
