...
@XmlRootElement(name = "cancelItemCheckoutResponse")
public class CancelItemCheckoutResponse
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CancelItemCheckoutResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CancelItemCheckoutResponse that = ((CancelItemCheckoutResponse) object);
        {
            boolean lhsSuccess;
