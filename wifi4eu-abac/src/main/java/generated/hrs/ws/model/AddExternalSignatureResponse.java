...
@XmlRootElement(name = "addExternalSignatureResponse")
public class AddExternalSignatureResponse
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof AddExternalSignatureResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final AddExternalSignatureResponse that = ((AddExternalSignatureResponse) object);
        {
            boolean lhsSuccess;
