 ...
 *       &lt;sequence>
 *         &lt;element name="document" type="{http://ec.europa.eu/sg/hrs/types}RegistrationSummary"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    implements Equals, HashCode, ToString
{
    ...
    protected RegistrationSummary document;
     ...
     * @return
     *     possible object is
     *     {@link RegistrationSummary }
     *     
     */
    public RegistrationSummary getDocument() {
        return document;
    }
     ...
     *     
     */
    public void setDocument(RegistrationSummary value) {
        this.document = value;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof RegisterDocumentResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final RegisterDocumentResponse that = ((RegisterDocumentResponse) object);
        {
            RegistrationSummary lhsDocument;
            lhsDocument = this.getDocument();
            RegistrationSummary rhsDocument;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            RegistrationSummary theDocument;
