 ...
 *         &lt;element name="request" type="{http://ec.europa.eu/sg/hrs/types}CreateFileRequest"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    implements Equals, HashCode, ToString
{
    ...
    @XmlElement(required = true)
    protected CreateFileRequest request;
     ...
     *     
     */
    public void setRequest(CreateFileRequest value) {
        this.request = value;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CreateFile)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CreateFile that = ((CreateFile) object);
        {
            Header lhsHeader;
        ...
        {
            CreateFileRequest lhsRequest;
            lhsRequest = this.getRequest();
            CreateFileRequest rhsRequest;
