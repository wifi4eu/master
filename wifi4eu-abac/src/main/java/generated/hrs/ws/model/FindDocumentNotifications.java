...
@XmlRootElement(name = "findDocumentNotifications")
public class FindDocumentNotifications
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof FindDocumentNotifications)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final FindDocumentNotifications that = ((FindDocumentNotifications) object);
        {
            Header lhsHeader;
