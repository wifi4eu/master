 ...
 *         &lt;element name="request" type="{http://ec.europa.eu/sg/hrs/types}DocumentRegistrationRequest"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "findPotentialRegisteredDuplicates")
public class FindPotentialRegisteredDuplicates
    implements Equals, HashCode, ToString
{
    ...
    @XmlElement(required = true)
    protected DocumentRegistrationRequest request;
     ...
     * @return
     *     possible object is
     *     {@link DocumentRegistrationRequest }
     *     
     */
    public DocumentRegistrationRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(DocumentRegistrationRequest value) {
        this.request = value;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof FindPotentialRegisteredDuplicates)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final FindPotentialRegisteredDuplicates that = ((FindPotentialRegisteredDuplicates) object);
        {
            Header lhsHeader;
        ...
        {
            DocumentRegistrationRequest lhsRequest;
            lhsRequest = this.getRequest();
            DocumentRegistrationRequest rhsRequest;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            DocumentRegistrationRequest theRequest;
