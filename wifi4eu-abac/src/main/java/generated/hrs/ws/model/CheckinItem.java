 ...
 *         &lt;element name="request" type="{http://ec.europa.eu/sg/hrs/types}ItemCheckinRequest"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    implements Equals, HashCode, ToString
{
    ...
    @XmlElement(required = true)
    protected ItemCheckinRequest request;
     ...
     * @return
     *     possible object is
     *     {@link ItemCheckinRequest }
     *     
     */
    public ItemCheckinRequest getRequest() {
        return request;
    }
     ...
     *     
     */
    public void setRequest(ItemCheckinRequest value) {
        this.request = value;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CheckinItem)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        {
            ItemCheckinRequest lhsRequest;
            lhsRequest = this.getRequest();
            ItemCheckinRequest rhsRequest;
