...
@XmlRootElement(name = "findPotentialRegisteredDuplicatesById")
public class FindPotentialRegisteredDuplicatesById
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof FindPotentialRegisteredDuplicatesById)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final FindPotentialRegisteredDuplicatesById that = ((FindPotentialRegisteredDuplicatesById) object);
        {
            Header lhsHeader;
