...
@XmlRootElement(name = "deleteDocumentNotifications")
public class DeleteDocumentNotifications
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DeleteDocumentNotifications)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DeleteDocumentNotifications that = ((DeleteDocumentNotifications) object);
        {
            Header lhsHeader;
