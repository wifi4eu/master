 ...
 *       &lt;sequence>
 *         &lt;element name="file" type="{http://ec.europa.eu/sg/hrs/types}File"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CreateFileResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CreateFileResponse that = ((CreateFileResponse) object);
        {
            File lhsFile;
