...
@XmlRootElement(name = "deleteAllSpecificMetadataResponse")
public class DeleteAllSpecificMetadataResponse
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DeleteAllSpecificMetadataResponse)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DeleteAllSpecificMetadataResponse that = ((DeleteAllSpecificMetadataResponse) object);
        {
            boolean lhsSuccess;
