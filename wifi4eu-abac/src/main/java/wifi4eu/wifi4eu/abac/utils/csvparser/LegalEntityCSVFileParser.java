...
public class LegalEntityCSVFileParser extends AbstractCSVFileParser {
	...
	protected List<LegalEntityInformationCSVRow> mapRowsToEntities(CSVParser csvParser) {
		...
		for (CSVRecord csvRecord : csvParser) {
			...
			legalEntityInformationCSVRow.setRegistrationNumber(StringUtils.isEmpty(csvRecord.get(LegalEntityCSVColumn.MUNICIPALITY_REGISTRATION_NUMBER)) ? null :
														Long.parseLong(csvRecord.get(LegalEntityCSVColumn.MUNICIPALITY_REGISTRATION_NUMBER)));
			legalEntityInformationCSVRow.setCallNumber(StringUtils.isEmpty(csvRecord.get(LegalEntityCSVColumn.MUNICIPALITY_CALL_NUMBER)) ? null :
