...
import wifi4eu.wifi4eu.abac.repository.LegalCommitmentyRepository;
...
public class LegalCommitmentService {
	...
	private LegalCommitmentyRepository legalCommitmentyRepository;

	@Autowired
	public LegalCommitmentService(LegalCommitmentyRepository legalCommitmentyRepository) {
