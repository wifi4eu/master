...
from (
select bc.PROCESSED, request.bc_id, request.submit_date, request.request_type, error_log_id, request.id as request_id, request.L_LOC_OBJ_FK, oj.obj_status_cd, oj.wkflw_stat_cd, err.msg_txt as error_message,
case
  when bc.PROCESSED = 'N'
  ...
  when bc.PROCESSED in ('OBJ_OK') or err.msg_txt is not null
  then 'ABAC_ERROR'
...
left join v_o_gen_object_References@ABAC_SHARED oj on oj.loc_sys_cd = 'WIF' and oj.loc_obj_Foreign_id = request.L_LOC_OBJ_FK
...
--------------------------------------------------------
  ...
  CREATE TABLE "WIFI4EU_ABAC"."WIF_LEGAL_ENTITY"
   (	"ID" NUMBER(18,0),
	...
	"ABAC_LATIN_NAME" VARCHAR2(400 BYTE),
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "WIFI4EU_ABAC"."SEQ_WIF_ABAC_STATUS"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 219101 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "WIFI4EU_ABAC" ;
--------------------------------------------------------
--  DDL for Index WIF_AUTH_USERS_ROLES_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "WIFI4EU_ABAC"."WIF_AUTH_USERS_ROLES_PK" ON "WIFI4EU_ABAC"."WIF_AUTH_USERS_ROLES" ("ROLE_ID", "USER_ID")
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "WIFI4EU_ABAC" ;
--------------------------------------------------------
--  DDL for Index WIF_AUTH_USERS_UN
--------------------------------------------------------

  CREATE UNIQUE INDEX "WIFI4EU_ABAC"."WIF_AUTH_USERS_UN" ON "WIFI4EU_ABAC"."WIF_AUTH_USERS" ("USERNAME")
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  TABLESPACE "WIFI4EU_ABAC" ;
--------------------------------------------------------
--  DDL for Index WIF_DOCUMENTS_PORTAL_ID_UN
--------------------------------------------------------

  CREATE UNIQUE INDEX "WIFI4EU_ABAC"."WIF_DOCUMENTS_PORTAL_ID_UN" ON "WIFI4EU_ABAC"."WIF_DOCUMENTS" ("PORTAL_ID")
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
BEGIN
  ...
  select
    le.ABAC_FEL_ID, 'WIFI4EU - ' || upper(le.OFFICIAL_NAME) || ' - Call n. ' || le.call_number, l_loc_obj_foreign_id || '.SECONDARY.' || le.ABAC_FEL_ID,
  ...
  Values
    ...
    '14', l_resp_org_struct_key_cd, l_resp_org_struct_tp_cd, 'FR2018', 'FR', 'EA', 'OPS', to_char(fdi_date, 'DD-MON-YYYY'));
  ...
  FOR budgetaryCommitment in (
      ...
      Values
        (l_run_id, position_row_id, l_loc_sys_cd, l_destination, 'COM', 'COM', 'CREATE', 'COMMITMENT POSITION',l_loc_obj_foreign_id,
      ...
      Insert into V_LOC_GEN_ORE_CRT@ABAC_SHARED
       ...
       Values
         (l_run_id, position_row_id+1, l_loc_sys_cd, l_destination, 'COM', 'COM', 'CREATE',
          'COMMITMENT CRITERIA', l_loc_obj_foreign_id, 'N', budgetaryCommitment.COMMITMENT_L2_POSITION, 'B18IT', 'NO-IT');
      ...
      Values
        (l_run_id, position_row_id+2, l_loc_sys_cd, l_destination, 'COM', 'COM', 'CREATE',
        'COMMITMENT COUNTRY', l_loc_obj_foreign_id, 'N',  UPPER(budgetaryCommitment.COUNTRY_CODE), '100', budgetaryCommitment.COMMITMENT_L2_POSITION);

      position_row_id := position_row_id + 5;
  ...
  END LOOP;
    ...
    Values
      (l_run_id, 40, l_loc_sys_cd, l_destination, 'COM', 'COM', 'CREATE', 'COMMITMENT RESP USER', l_loc_obj_foreign_id, 'N', user_imported_login/*'VANDEJN'*/);
  ...
  Values
    ...
    'AC', user_imported_name, 'VISA GIVEN BY WIFI4EU', user_imported_login, l_visa_wlkflw_center_cd, l_visa_wlkflw_orgname, 'FA', user_imported_login);
...
set define off;
  ...
  local_identifier          varchar2(2000);
  user_reference            varchar2(2000);
BEGIN
  ...
  FOR legalCommitment in (
    select le_fel_id, lc_id, COMMITMENT_L2_KEY, GRANT_AGREEMENT_CNTRSIGN_DATE, OFFICIAL_NAME, user_imported_login, user_imported_name, country_name, call_number, cs_ga_ares_ref, sum(COMMITMENT_L2_AMOUNT) as COMMITMENT_L2_AMOUNT
    from
    ...
    upper(le.user_imported) as user_imported_login, (upper(u.last_name) || ' ' || u.first_name) as user_imported_name, country.name as country_name, le.call_number, doc.ares_reference as cs_ga_ares_ref
    from wif_legal_commitment lc
    join wif_legal_entity le on le.id = lc.legal_entity_id
    join wif_country country on le.country_code = country.iso2_code
    join WIF_AUTH_USERS u on le.user_imported = u.USERNAME
    ...
    join wif_documents doc on doc.id = grant_agreement_doc_id
    where lc.id = LEGAL_COMMITMENT_ID and lc.WF_STATUS = status_countersigned)
    group by le_fel_id, lc_id, COMMITMENT_L2_KEY, GRANT_AGREEMENT_CNTRSIGN_DATE, OFFICIAL_NAME, user_imported_login, user_imported_name, country_name, call_number, cs_ga_ares_ref
  ) loop

      local_identifier := upper('WiFi4EU - ' || legalCommitment.OFFICIAL_NAME || ' - Call n. ' || legalCommitment.call_number);
      user_reference := upper('WiFi4EU initiative for the financing of the equipment and installation of free WiFi hotspots in the EU in ' || legalCommitment.OFFICIAL_NAME || ' / ' || legalCommitment.country_name);
      ...
      Insert into V_LOC_LCM_HEADER@ABAC_SHARED
       (RUN_ID, ROW_ID, LOC_SYS_CD, DESTINATION, TRANS_AREA_CD,
        ...
        FTS_RESTRICTION_CD,
        RESP_ORG_STRUCT_KEY_CD, RESP_ORG_STRUCT_TP_CD,
        FIRST_PRE_FIN_REQ_DUE_CSD_FLG,
     ...
     Values
       (l_run_id, 10, l_loc_sys_cd, l_destination, 'LCM',
        ...
        'NR',
        l_resp_org_struct_key_cd, l_resp_org_struct_tp_cd,
        'N',
        'FR2018', 'FR2018', to_char(legalCommitment.GRANT_AGREEMENT_CNTRSIGN_DATE, 'DD-MON-YYYY'),
        'EX_OTHER', 'FR', 'BSC',
        legalCommitment.COMMITMENT_L2_AMOUNT, 'EUR',
        'AMT', local_identifier, 'ACTGRANT',
        user_reference, to_char(legalCommitment.GRANT_AGREEMENT_CNTRSIGN_DATE, 'DD-MON-YYYY'), 'N', to_char(legalCommitment.GRANT_AGREEMENT_CNTRSIGN_DATE, 'DD-MON-YYYY'),
      ...
      Insert into V_LOC_GEN_ORE_RSP_USERS@ABAC_SHARED
        (RUN_ID, ROW_ID, LOC_SYS_CD, DESTINATION, TRANS_AREA_CD, TRANS_TP_CD, TRANS_ACTION_CD, TABLE_ALIAS, LOC_OBJ_FOREIGN_ID, PROCESSED, PERSON_ID)
      Values
        (l_run_id, 40, l_loc_sys_cd, l_destination, 'LCM', 'LCH', 'CREATE', 'LEGAL COMMITMENT RESP USER', l_loc_obj_foreign_id, 'N', legalCommitment.user_imported_login/*'BILLEWO'*/);
      ...
      Values
       ...
       'N', 'AC', legalCommitment.user_imported_name, 'VISA GIVEN BY WIFI4EU', legalCommitment.user_imported_login, 'LEGAL_COMMITMENT', l_visa_wlkflw_orgname, 'FA', legalCommitment.user_imported_login);
...
(LEGALENTITYID IN NUMBER ) AS
  ...
  official_name_1           varchar2(35);
  official_name_2           varchar2(35);
  official_name_3           varchar2(35);
  official_name_4           varchar2(35);
  street_1                  varchar2(25);
...
BEGIN
 ...
 SELECT VALUE INTO l_resp_org_struct_id from WIF_CONSTANTS WHERE NAME='LEF_V_LOC_RESP_ORG_STRUCT_ID'; --ID COMES FROM V_O_ORG_STRUCTURES@abac_shared
 SELECT VALUE INTO l_resp_org_struct_key_cd from WIF_CONSTANTS WHERE NAME='LEF_V_LOC_RESP_ORG_STRUCT_KEY_CD';
 SELECT VALUE INTO l_resp_org_struct_tp_cd from WIF_CONSTANTS WHERE NAME='LEF_V_LOC_RESP_ORG_STRUCT_TP_CD';
 ...
 l_loc_obj_foreign_id:= l_loc_sys_cd || '.' || to_char(l_run_id);
  ...
  FOR legalEntity in (
    ...
    official_name_1 := substr(legalEntity.ABAC_LATIN_NAME, 1,35);
    official_name_2 := substr(legalEntity.ABAC_LATIN_NAME, 36,35);
    official_name_3 := substr(legalEntity.ABAC_LATIN_NAME, 71,35);
    official_name_4 := substr(legalEntity.ABAC_LATIN_NAME, 106,35);

    street_1 := substr(upper(legalEntity.ABAC_LATIN_ADDRESS), 1, 25);
    street_2 := substr(upper(legalEntity.ABAC_LATIN_ADDRESS), 26, 40);
    street_3 := substr(upper(legalEntity.ABAC_LATIN_ADDRESS), 66, 40);
   ...
   Values
     (l_run_id, 10, l_loc_sys_cd, l_destination, l_trans_area_cd,
      ...
      UPPER(legalEntity.COUNTRY_CODE), l_language_cd, official_name_1, 'SUP', street_1,
      official_name_1, NULL, legalEntity.POSTAL_CODE, NULL, NULL,
      NULL, NULL, NULL, NULL, NULL,
      l_debtor_cat_id, NULL, NULL, NULL, l_legal_type_cd,
      NULL, NULL, NULL, NULL, street_2,
      street_3, NULL, official_name_2, official_name_3, official_name_4,
...
--------------------------------------------------------
  ...
  ALTER TABLE "WIFI4EU_ABAC"."WIF_LEGAL_ENTITY" MODIFY ("CALL_NUMBER" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "WIFI4EU_ABAC"."WIF_AUTH_USERS_ROLES" ADD CONSTRAINT "WIF_AUTH_USERS_ROLES_PK" PRIMARY KEY ("ROLE_ID", "USER_ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "WIFI4EU_ABAC"."WIF_AUTH_USERS" ADD CONSTRAINT "WIF_AUTH_USERS_UN" UNIQUE ("USERNAME")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
--  Ref Constraints for Table WIF_AUTH_USERS_ROLES
--------------------------------------------------------

  ALTER TABLE "WIFI4EU_ABAC"."WIF_AUTH_USERS_ROLES" ADD CONSTRAINT "WIF_AUTH_USERS_ROLES_ROLES_FK" FOREIGN KEY ("ROLE_ID")
	  REFERENCES "WIFI4EU_ABAC"."WIF_AUTH_ROLES" ("ID") ENABLE;
  ALTER TABLE "WIFI4EU_ABAC"."WIF_AUTH_USERS_ROLES" ADD CONSTRAINT "WIF_AUTH_USERS_ROLES_USERS_FK" FOREIGN KEY ("USER_ID")
	  REFERENCES "WIFI4EU_ABAC"."WIF_AUTH_USERS" ("ID") ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "WIFI4EU_ABAC"."WIF_LEGAL_ENTITY" ADD CONSTRAINT "WIF_LEGAL_ENTITY_USER_EXPTD_FK" FOREIGN KEY ("USER_EXPORTED")
	  REFERENCES "WIFI4EU_ABAC"."WIF_AUTH_USERS" ("USERNAME") ENABLE;
  ALTER TABLE "WIFI4EU_ABAC"."WIF_LEGAL_ENTITY" ADD CONSTRAINT "WIF_LEGAL_ENTITY_USER_IMPTD_FK" FOREIGN KEY ("USER_IMPORTED")
	  REFERENCES "WIFI4EU_ABAC"."WIF_AUTH_USERS" ("USERNAME") ENABLE;
