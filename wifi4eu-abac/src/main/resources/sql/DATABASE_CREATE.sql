--------------------------------------------------------
--  DDL for DB Link ABACBUDL.CC.CEC.EU.INT
--------------------------------------------------------

  CREATE DATABASE LINK "ABACBUDL.CC.CEC.EU.INT"
   CONNECT TO "WIFI4EU$" IDENTIFIED BY VALUES ':1'
   USING 'ABACBUDL';
--------------------------------------------------------
--  DDL for DB Link ABACBUDL_SHARED.CC.CEC.EU.INT
--------------------------------------------------------

  CREATE SHARED DATABASE LINK "ABACBUDL_SHARED.CC.CEC.EU.INT"
   CONNECT TO "WIFI4EU$" IDENTIFIED BY VALUES ':1'
...
left join V_LOC_COMMITMENT_HEADER@ABACBUDL_SHARED bc on request.L_LOC_OBJ_FK = (bc.loc_sys_cd || '.' || bc.run_id)
left join v_o_gen_object_References@ABACBUDL_SHARED oj on oj.loc_sys_cd = 'WIF' and ('WIF.' || substr(oj.loc_obj_Foreign_id, 5, instr(oj.loc_obj_Foreign_id, '.')+1)) = request.L_LOC_OBJ_FK
left join V_O_LOG_ERRORS@ABACBUDL_SHARED err ON err.loc_sys_cd = 'WIF' and request.L_LOC_OBJ_FK = (err.loc_sys_cd || '.' || err.batch_id) and err.msg_tp_cd <> 'I'
...
from wif_abac_request_process request
left join V_LOC_LCM_HEADER@ABACBUDL_SHARED lc on request.L_LOC_OBJ_FK = (lc.loc_sys_cd || '.' || lc.run_id)
left join v_o_gen_object_References@ABACBUDL_SHARED oj on oj.loc_obj_Foreign_id = request.L_LOC_OBJ_FK
left join V_O_LOG_ERRORS@ABACBUDL_SHARED err ON err.loc_sys_cd = 'WIF' and request.L_LOC_OBJ_FK = (err.loc_sys_cd || '.' || err.batch_id) and err.msg_tp_cd <> 'I'
...
FROM V_LOC_THP_LEGAL_ENTITIES@ABACBUDL_SHARED le
LEFT JOIN V_O_LOG_ERRORS@ABACBUDL_SHARED err ON err.batch_id = le.run_id and err.loc_sys_cd = le.loc_sys_cd and err.msg_tp_cd <> 'I'
LEFT JOIN V_O_THP_COMMON_LOCAL_LINKS@ABACBUDL_SHARED lekey ON lekey.loc_obj_foreign_id = le.loc_obj_foreign_id
LEFT JOIN V_LOC_THP_COMMON_LOCAL_LINKS@ABACBUDL_SHARED lelinks ON lelinks.loc_obj_foreign_id = le.loc_obj_foreign_id
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "WIFI4EU_ABAC"."SEQ_ABAC_RUN_ID"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 20980 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "WIFI4EU_ABAC"."SEQ_BC_LEVEL2_POSITION"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 61 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence SEQ_BUDGETARY_COMMITMENT
--------------------------------------------------------

   CREATE SEQUENCE  "WIFI4EU_ABAC"."SEQ_BUDGETARY_COMMITMENT"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 61 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence SEQ_DOCUMENT
--------------------------------------------------------

   CREATE SEQUENCE  "WIFI4EU_ABAC"."SEQ_DOCUMENT"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 141 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence SEQ_IMPORT_LOG
--------------------------------------------------------

   CREATE SEQUENCE  "WIFI4EU_ABAC"."SEQ_IMPORT_LOG"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 61 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence SEQ_LEGAL_COMMITMENT
--------------------------------------------------------

   CREATE SEQUENCE  "WIFI4EU_ABAC"."SEQ_LEGAL_COMMITMENT"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 41 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence SEQ_LEGAL_ENTITY
--------------------------------------------------------

   CREATE SEQUENCE  "WIFI4EU_ABAC"."SEQ_LEGAL_ENTITY"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 271 NOCACHE  NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence SEQ_NOTIFICATION
--------------------------------------------------------

   CREATE SEQUENCE  "WIFI4EU_ABAC"."SEQ_NOTIFICATION"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 61 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence SEQ_WIF_ABAC_STATUS
--------------------------------------------------------

   CREATE SEQUENCE  "WIFI4EU_ABAC"."SEQ_WIF_ABAC_STATUS"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 321 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
BEGIN
  ...
  Insert into V_ABAC_BATCHINT_LOGIN@ABACBUDL_SHARED  Values ('X');

  --STEP 1 - Creation of the Commitment header
  /* to be provided by Wifi4EY : TITLE (in upperCase !!!) and  WKFLW_FDI_DT */
  Insert into V_LOC_COMMITMENT_HEADER@ABACBUDL_SHARED
  ...
  Values
    (l_run_id, 10, l_loc_sys_cd, 'ABACBUDL', 'COM', 'COM', 'CREATE', 'COMMITMENT HEADER', l_loc_obj_foreign_id, 'N', 'RG',
  ...
  FOR bugetaryCommitment in (
      ...
      l_BC_ID := bugetaryCommitment.BC_ID;
      ...
      Insert into V_LOC_COMMITMENT_POSITION@ABACBUDL_SHARED
      ...
      Values
        (l_run_id, 20, l_loc_sys_cd, 'ABACBUDL', 'COM', 'COM', 'CREATE', 'COMMITMENT POSITION',l_loc_obj_foreign_id,
      ...
      Insert into V_LOC_GEN_ORE_CRT@ABACBUDL_SHARED
       ...
       Values
         (l_run_id, 23, l_loc_sys_cd, 'ABACBUDL', 'COM', 'COM', 'CREATE',
      ...
      Insert into V_LOC_GEN_ORE_CTY@ABACBUDL_SHARED
        (RUN_ID, ROW_ID, LOC_SYS_CD, DESTINATION, TRANS_AREA_CD, TRANS_TP_CD, TRANS_ACTION_CD,
        TABLE_ALIAS, LOC_OBJ_FOREIGN_ID, PROCESSED, CTY_ISO2_CD, PCT, TRANS_POS_NR)
      Values
        (l_run_id, 26, l_loc_sys_cd, 'ABACBUDL', 'COM', 'COM', 'CREATE',
  ...
  END LOOP;
    ...
    Insert into V_LOC_GEN_ORE_RSP_USERS@ABACBUDL_SHARED
    ...
    Values
      (l_run_id, 40, l_loc_sys_cd, 'ABACBUDL', 'COM', 'COM', 'CREATE', 'COMMITMENT RESP USER', l_loc_obj_foreign_id, 'N', 'VANDEJN');
    ...
    Insert into V_LOC_COM_CONTRACTOR_REF@ABACBUDL_SHARED
      (RUN_ID, ROW_ID, LOC_SYS_CD, DESTINATION, TRANS_AREA_CD, TRANS_TP_CD, TRANS_ACTION_CD, TABLE_ALIAS, LOC_OBJ_FOREIGN_ID,
       PROCESSED, CONTRACTOR_REF_TYPE_CD, STATUS_CD, CONTR_REF_LOC_OBJ_FOREIGN_ID, SUP_LOC_OBJ_FOREIGN_ID)
    Values
      (l_run_id, 50, l_loc_sys_cd, 'ABACBUDL', 'COM', 'COM', 'CREATE', 'COMMITMENT CONTRACTOR REF', l_loc_obj_foreign_id,
      'N', 'SECONDARY', 'ACTIVE', CONTR_REF_LOC_OBJ_FOREIGN_ID, ABAC_FEL_ID);

    --STEP 5 - Attach a document to the LE
  Insert into V_LOC_GEN_DOCS_REFERENCES@ABACBUDL_SHARED
  ...
  Values
     (l_run_id, 60, l_loc_sys_cd, 'ABACBUDL', 'COM', 'COM', 'CREATE', 'DOCUMENT REFERENCE', l_loc_obj_foreign_id, 'N', 'ARES(2018)456789', 'bla bla');
  ...
  Insert into V_LOC_VISA@ABACBUDL_SHARED
  ...
  Values
    (l_run_id, 80, l_loc_sys_cd, 'ABACBUDL', 'COM', 'COM', 'CREATE', 'VISA', l_loc_obj_foreign_id, 'N',
  ...
  pck_abac_batchint_client.p_submit_batch@ABACBUDL_SHARED(l_run_id, l_loc_sys_cd, 'BATCH_QUE1', l_que_id);
...
BEGIN
  ...
  FOR legalCommitment in (
    ...
    where lc.WF_STATUS = 'COUNTERSIGNED'
      ...
      -- STEP 1 - Creation of the Commitment header
      Insert into V_LOC_LCM_HEADER@ABACBUDL_SHARED
     ...
     Values
       (l_run_id, 10, l_loc_sys_cd, 'ABACBUDL', 'LCM',
      ...
      Insert into V_LOC_LCM_CONTRACT_MGMT@ABACBUDL_SHARED
      ...
      Values
       (l_run_id, 20, l_loc_sys_cd, 'ABACBUDL', 'LCM', 'LCH', 'CREATE', 'LEGAL COMMITMENT CONTRACT MGMT', l_loc_obj_foreign_id, 'N', legalCommitment.LE_FEL_ID, 'BC', legalCommitment.COMMITMENT_L2_AMOUNT);

      -- STEP 3 - Registration of responsible person
      Insert into V_LOC_GEN_ORE_RSP_USERS@ABACBUDL_SHARED
        (RUN_ID, ROW_ID, LOC_SYS_CD, DESTINATION, TRANS_AREA_CD, TRANS_TP_CD, TRANS_ACTION_CD, TABLE_ALIAS, LOC_OBJ_FOREIGN_ID, PROCESSED, PERSON_ID)
      Values
        (l_run_id, 40, l_loc_sys_cd, 'ABACBUDL', 'LCM', 'LCH', 'CREATE', 'LEGAL COMMITMENT RESP USER', l_loc_obj_foreign_id, 'N', 'BILLEWO');


      -- STEP 4 - Registration of the related Budget Commitment
      Insert into V_LOC_LCM_HEADER_COM_LINK@ABACBUDL_SHARED
      ...
      Values
         (l_run_id, 110, l_loc_sys_cd, 'ABACBUDL', 'LCM', 'LCH', 'CREATE', 'LEGAL COMMITMENT HEADER LINK', l_loc_obj_foreign_id, 'N', legalCommitment.COMMITMENT_L2_KEY);
     ...
     Values
       (l_run_id, 120, l_loc_sys_cd, 'ABACBUDL', 'LCM', 'LCH', 'CREATE', 'VISA', l_loc_obj_foreign_id,
       'N', 'AC', 'VANDERHAEGEN Johan', 'VISA GIVEN BY WIFI4EU', 'VANDEJN', 'LEGAL_COMMITMENT', 'INEA', 'FA','VANDEJN');

      -- STEP 6 - Call the stored procedure to process the data
      pck_abac_batchint_client.p_submit_batch@ABACBUDL_SHARED(l_run_id, l_loc_sys_cd, 'BATCH_QUE1', l_que_id);
...
BEGIN
 ...
 FOR legatEntity in (SELECT * FROM WIF_LEGAL_ENTITY WHERE ID=l_LE_ID) LOOP
    ...
    begin
      SELECT * INTO supporting_doc FROM WIF_DOCUMENTS WHERE LEGAL_ENTITY_ID=legatEntity.ID AND DOCUMENT_TYPE='IDENTIFICATION_FORM' AND ROWNUM=1 ORDER BY DATE_CREATED desc;
    ...
    select LANGUAGE_CD into l_language_cd from V_O_GEN_LANGUAGES@ABACBUDL_SHARED
    ...
    Insert into V_LOC_THP_LEGAL_ENTITIES@ABACBUDL_SHARED
     (RUN_ID, ROW_ID, LOC_SYS_CD, DESTINATION, TRANS_AREA_CD,
      TRANS_TP_CD, TRANS_ACTION_CD, TABLE_ALIAS, LOC_OBJ_FOREIGN_ID, PROCESSED,
     ...
     (l_run_id, 10, l_loc_sys_cd, l_destination, l_trans_area_cd,
      ...
      ELSE
        /*
          ...
          Insert into V_LOC_GEN_SCAN_DOC@ABACBUDL_SHARED
             (RUN_ID, ROW_ID, LOC_SYS_CD, DESTINATION, TRANS_AREA_CD,
              TRANS_TP_CD, TRANS_ACTION_CD, TABLE_ALIAS, LOC_OBJ_FOREIGN_ID, PROCESSED,
          ...
          --WORKAROUNG TO AVOID THE PROCESS FROM FAILING UNTIL WE SOLVE THE ISSUE WITH THE BLOB TRANSFER VIA DBLINK
            Insert into V_LOC_GEN_DOCS_REFERENCES@ABACBUDL_SHARED
               (RUN_ID, ROW_ID, LOC_SYS_CD, DESTINATION, TRANS_AREA_CD,
                TRANS_TP_CD, TRANS_ACTION_CD, TABLE_ALIAS, LOC_OBJ_FOREIGN_ID, PROCESSED,
                DOC_REFERENCE, DOC_DESCRIPTION, OFFICIAL_DOC_FLG)
...
BEGIN
  ...
  rows_affected := 0;
  for request in (
                  select bc.id as bc_id, l_loc_obj_fk, bc.WF_STATUS as bc_status, status_vw.status as abac_status, status_vw.ERROR_MSG
  ...
  loop
      ...
      if (request.bc_status <> request.abac_status) then
        ...
        for position in (
                        ...
                        join V_LOC_COMMITMENT_POSITION@ABACBUDL_SHARED abac_pos on wif_pos.commitment_l2_position = abac_pos.commit_pos_line_no and abac_pos.loc_obj_foreign_id = request.l_loc_obj_fk
