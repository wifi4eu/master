...
--------------------------------------------------------
  ...
  CREATE TABLE "WIFI4EU_ABAC"."WIF_LEGAL_COMMITMENT"
   ...
   COMMENT ON COLUMN "WIFI4EU_ABAC"."WIF_LEGAL_COMMITMENT"."DATE_CREATED" IS 'Creation date';
   COMMENT ON COLUMN "WIFI4EU_ABAC"."WIF_LEGAL_COMMITMENT"."DATE_UPDATED" IS 'Modification date';
   COMMENT ON COLUMN "WIFI4EU_ABAC"."WIF_LEGAL_COMMITMENT"."COUNTERSIGNATURE_DATE" IS 'Date when the countersignature was applied';
