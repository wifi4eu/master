...
Insert into WIF_CONSTANTS (ID,NAME,VALUE) values (14,'LEF_V_LOC_VISA_SIGNATURE','DRAME Abdoulaye');
Insert into WIF_CONSTANTS (ID,NAME,VALUE) values (15,'LEF_V_LOC_VISA_DEFAULT_COMMENT','VISA GIVEN BY WIFI4EU');
Insert into WIF_CONSTANTS (ID,NAME,VALUE) values (16,'LEF_V_LOC_VISA_AGENT_ID','drameae');
Insert into WIF_CONSTANTS (ID,NAME,VALUE) values (17,'LEF_V_LOC_VISA_WRKFLW_CENTER_CD','INEA_DEFAULT');
...
Insert into WIF_CONSTANTS (ID,NAME,VALUE) values (20,'LEF_V_LOC_VISA_SUPPLIED_AGENT_NAME','drameae');
