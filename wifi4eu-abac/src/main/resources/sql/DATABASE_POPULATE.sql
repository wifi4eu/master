...
Insert into WIFI4EU_ABAC.WIF_COUNTRY (ISO2_CODE,NAME,CCM2_CODE,NATIVE_DESCRIPTIONS,ISO3_CODE) values ('UK','United Kingdom',20000893,'United Kingdom','GBR');
...
Insert into WIFI4EU_ABAC.WIF_COUNTRY (ISO2_CODE,NAME,CCM2_CODE,NATIVE_DESCRIPTIONS,ISO3_CODE) values ('EL','Greece',20000902,'Hellas/Ελλάς or Ellada/Ελλάδα','GRC');
