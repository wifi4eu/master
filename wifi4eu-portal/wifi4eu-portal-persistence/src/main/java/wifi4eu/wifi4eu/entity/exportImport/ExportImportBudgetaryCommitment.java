...
public class ExportImportBudgetaryCommitment implements Serializable {
    ...
    public ExportImportBudgetaryCommitment() {}

    public ExportImportBudgetaryCommitment(Integer id, Integer euRank, Integer countryRank, String countryName, String municipalityName, String issue, Integer numberOfRegistrations, String abacReference, String abacStandarName, Integer municipality) {
        this.id = id;
        this.euRank = euRank;
    ...
    public String toString() {
        return "ExportImportBudgetaryCommitment{" +
                "id=" + id + '\'' +
                ", euRank=" + euRank + '\'' +
