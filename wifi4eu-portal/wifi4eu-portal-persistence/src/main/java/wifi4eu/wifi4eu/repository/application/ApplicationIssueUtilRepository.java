...
public interface ApplicationIssueUtilRepository extends CrudRepository<ApplicationIssueUtil,Integer> {
    @Query(value = "select r.id as id, l.country_code as countryCode, u.email as userEmail, u.ecas_email as userEcasEmail, u.lang as userLang, may.email as mayorEmail from laus l \n" +
