...
@Component({
  templateUrl: 'beneficiary-registrations2.component.html', providers: [BeneficiaryApi, LauApi, MayorApi, UserApi, MunicipalityApi]
})

export class DgConnBeneficiaryRegistrations2Component {
