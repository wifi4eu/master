...
export class CallApi implements ICallApi {
    ...
    private allCallsWithHttpInfo(): Observable<Response> {
        ...
        let requestOptions: RequestOptionsArgs = new RequestOptions({
            ...
            responseType: "/call".indexOf('Excel') == -1 ? ResponseContentType.Json : ResponseContentType.Blob
        });
...
// (https://basarat.gitbooks.io/typescript/content/docs/template-strings.html)
        ...
        let requestOptions: RequestOptionsArgs = new RequestOptions({
            ...
            headers: headers,
            search: queryParameters,
            responseType: "/call/${callId}".indexOf('Excel') == -1 ? ResponseContentType.Json : ResponseContentType.Blob
        });
