...
export class BeneficiaryRegistrationStep4Component {
    ...
    private legalChecks: boolean[] = [false, false, false, false, false, false, false, false, false, false];
    ...
    private back() {
        this.onBack.emit();
        this.legalChecks = [false, false, false, false, false, false, false, false, false, false];
    }
