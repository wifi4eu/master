...
public class ApplyVoucherResource {
    ...
    @ResponseBody
    public List<ApplyVoucher> getRegistrationsByUserId(@PathVariable("userId") final Integer userId, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            List<ApplyVoucher> applyVouchers = applyVoucherService.getDataForApplyVoucher(userId);
