...
/*    @ApiOperation(value = "Get all the registrations")
    ...
    public ResponseDTO changeConditionsAgreementStatus(@RequestBody final ConditionsAgreementDTO conditionsAgreementDTO, @RequestParam("status") final Integer status, HttpServletResponse response, HttpServletRequest request) throws IOException {
        ...
        try {
            ...
            ConditionsAgreementDTO conditionsAgreementDTOReturned = registrationService.saveConditionsAgreementDTO(userConnected.getId(), conditionsAgreementDTO.getRegistrationId(), conditionsAgreementDTO.getStatus());
