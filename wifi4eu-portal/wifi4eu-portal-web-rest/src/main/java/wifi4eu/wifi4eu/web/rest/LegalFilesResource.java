...
@CrossOrigin(origins = "*")
@Controller
@Api(value = "/legalFiles", description = "Legal Files object REST API services")
@RequestMapping("legalFiles")
public class LegalFilesResource {

    Logger _log = LogManager.getLogger(LegalFilesResource.class);
