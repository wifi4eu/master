...
public class BeneficiaryMyInstallationResource {
    ...
    @ResponseBody
    public ResponseDTO getMyInstallationData(HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            return beneficiaryMyInstallationService.getMyInstallationData(supplier.getId(), userConnected.getEcasUsername());
        } catch (Exception e) {
            _log.error("ECAS Username: " + userConnected.getEcasUsername() + "- You have no permissions to retrieve the beneficiary list", e
                    .getMessage());
    ...
    @ResponseBody
    public ResponseDTO attributeBankAccountToBeneficiary(@PathVariable("beneficiary")final Integer beneficiaryId, @PathVariable("bankAccount")final Integer bankAccountId,
