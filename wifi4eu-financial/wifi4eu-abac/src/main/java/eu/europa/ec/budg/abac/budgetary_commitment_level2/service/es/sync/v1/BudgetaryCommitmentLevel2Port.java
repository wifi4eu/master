...
public interface BudgetaryCommitmentLevel2Port {
    ...
    public eu.europa.ec.budg.abac.budgetary_commitment_level2.v1.BudgetaryCommitmentLevel2GetResponseType get(
            @WebParam(partName = "request", name = "BudgetaryCommitmentLevel2GetRequest", targetNamespace = "http://www.ec.europa.eu/budg/abac/budgetary_commitment_level2/v1")
                    eu.europa.ec.budg.abac.budgetary_commitment_level2.v1.BudgetaryCommitmentLevel2GetRequestType request
