 ...
 *       &lt;sequence&gt;
 *         &lt;element name="BudgetaryCommitmentLevel2Position" type="{http://www.ec.europa.eu/budg/abac/budgetary_commitment_level2/v1}BudgetaryCommitmentLevel2PositionCreateType" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class CommitmentPositionsType {
    ...
    protected List<BudgetaryCommitmentLevel2PositionCreateType> budgetaryCommitmentLevel2Position;
     ...
     * 
     */
    public List<BudgetaryCommitmentLevel2PositionCreateType> getBudgetaryCommitmentLevel2Position() {
        if (budgetaryCommitmentLevel2Position == null) {
            budgetaryCommitmentLevel2Position = new ArrayList<BudgetaryCommitmentLevel2PositionCreateType>();
        }
