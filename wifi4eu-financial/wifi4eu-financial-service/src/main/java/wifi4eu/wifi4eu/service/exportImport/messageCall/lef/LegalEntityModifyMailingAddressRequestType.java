...
/**
 * <p>Clase Java para LegalEntityModifyMailingAddressRequestType complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="LegalEntityModifyMailingAddressRequestType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "LegalEntityModifyMailingAddressRequestType", propOrder = {
    "localKey",
    "mailingAddress"
})
public class LegalEntityModifyMailingAddressRequestType
