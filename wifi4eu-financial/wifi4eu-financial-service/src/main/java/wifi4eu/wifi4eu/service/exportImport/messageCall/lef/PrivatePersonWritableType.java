...
/**
 * <p>Clase Java para PrivatePersonWritableType complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="PrivatePersonWritableType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "PrivatePersonWritableType", propOrder = {
    "birthCity",
    "businessName",
    "isSelfEmployed",
    "registrationInfo",
...
@XmlSeeAlso({
    ExStaffMemberWritableType.class
})
public class PrivatePersonWritableType
