...
/**
 * <p>Clase Java para PublicPrivateLawBodyWritableType complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="PublicPrivateLawBodyWritableType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "PublicPrivateLawBodyWritableType", propOrder = {
    "acronym",
    "businessName",
    "fpoTypeCode",
    "isNgo",
...
@XmlSeeAlso({
    PublicLawBodyWritableType.class,
    PrivateLawBodyWritableType.class
})
public abstract class PublicPrivateLawBodyWritableType
