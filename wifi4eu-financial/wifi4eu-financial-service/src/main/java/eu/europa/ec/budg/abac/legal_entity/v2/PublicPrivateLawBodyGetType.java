...
/**
 * <p>Clase Java para PublicPrivateLawBodyGetType complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="PublicPrivateLawBodyGetType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "PublicPrivateLawBodyGetType", propOrder = {
    "acronym",
    "businessName",
    "fpoTypeCode",
    "isNgo",
...
@XmlSeeAlso({
    PublicLawBodyGetType.class,
    PrivateLawBodyGetType.class
})
public abstract class PublicPrivateLawBodyGetType
