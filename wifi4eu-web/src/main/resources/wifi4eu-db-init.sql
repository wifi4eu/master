...
CREATE TABLE LOC_NUTS_T (NUTS_ID INTEGER NOT NULL ,CODE LONGTEXT NOT NULL , NAME LONGTEXT NOT NULL , LEVEL INTEGER NOT NULL , CONTRY_CODE LONGTEXT NOT NULL , _ORDER INTEGER NOT NULL , SORTING INTEGER NOT NULL , PRIMARY KEY (NUTS_ID));
CREATE TABLE LOC_LAU_T ( LAU_ID INTEGER NOT NULL , COUNTRY_CODE LONGTEXT NOT NULL , NUTS3 LONGTEXT NOT NULL , LAU1 LONGTEXT NOT NULL , LAU2 LONGTEXT NOT NULL , _CHANGE LONGTEXT NOT NULL , NAME1 LONGTEXT NOT NULL , NAME2 LONGTEXT NOT NULL , POP INTEGER NOT NULL , AREA INTEGER NOT NULL , PRIMARY KEY (LAU_ID));
