...
export interface IHelpdeskApi {
     ...
     * @param body 
     */
    createHelpdeskIssue<T extends models.ResponseDTO>(body?: models.HelpdeskDTO, c?: ClassType<T>): Observable<T>;
    /**
     ...
     * @param issueId 
     */
    getHelpdeskIssue<T extends models.HelpdeskDTO>(issueId: number, c?: ClassType<T>): Observable<T>;
...
export class HelpdeskApi implements IHelpdeskApi {
     ...
     * @param body 
     */
    private createHelpdeskIssueWithHttpInfo(body?: models.HelpdeskDTO ): Observable<Response> {
        const path = this.basePath + `/helpdesk`;
