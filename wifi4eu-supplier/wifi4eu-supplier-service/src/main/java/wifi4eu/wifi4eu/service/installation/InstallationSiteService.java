...
public class InstallationSiteService {
    ...
    private String[] FIELDS_INSTALLATION_SITE_ACCEPT = {"name","domain_name"};
    ...
    public ResponseDTO findInstallationSitesByBeneficiariesOrdered(Map<String, Object> map){
        ...
        if (!map.isEmpty()){
            ...
            try{
                ...
                ArrayList<InstallationSite> installationSites = Lists.newArrayList(installationSiteRepository.searchInstallationSitesByBeneficiary(page,delta,id,field,order));
                // int countResults = installationSiteRepository.countInstallationSitesByBeneficiary(id);
