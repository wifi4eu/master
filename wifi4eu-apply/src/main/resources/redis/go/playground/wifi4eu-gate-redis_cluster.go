...
func main() {
	...
	// ENVIRONMENT
	sentinelURI := "127.0.0.1:26379"
	//redisURI := "127.0.0.1:26379"
	...
	//redisPool, err := pool.New("tcp", redisURI, 20000)
	client, err := sentinel.NewClient("tcp", sentinelURI, 20000, "master1", "resque")
