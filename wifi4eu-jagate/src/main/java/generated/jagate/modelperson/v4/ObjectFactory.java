 ...
 * generated in the generated.jagate.modelperson.v4 package. 
...
public class ObjectFactory {
    ...
    private final static QName _Person_QNAME = new QName("http://ec.europa.eu/research/fp/model/person/V4", "Person");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: generated.jagate.modelperson.v4
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ec.europa.eu/research/fp/model/person/V4", name = "Person")
