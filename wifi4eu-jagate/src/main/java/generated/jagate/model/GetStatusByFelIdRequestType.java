...
/**
 * <p>Java class for GetStatusByFelIdRequestType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="GetStatusByFelIdRequestType">
 *   &lt;complexContent>
...
@XmlType(name = "GetStatusByFelIdRequestType", propOrder = {
    "felId"
})
public class GetStatusByFelIdRequestType
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetStatusByFelIdRequestType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GetStatusByFelIdRequestType that = ((GetStatusByFelIdRequestType) object);
        {
