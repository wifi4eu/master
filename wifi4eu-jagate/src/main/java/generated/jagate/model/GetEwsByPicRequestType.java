...
/**
 * <p>Java class for GetEwsByPicRequestType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="GetEwsByPicRequestType">
 *   &lt;complexContent>
...
@XmlType(name = "GetEwsByPicRequestType", propOrder = {
    "pic"
})
public class GetEwsByPicRequestType
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetEwsByPicRequestType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GetEwsByPicRequestType that = ((GetEwsByPicRequestType) object);
        {
            List<String> lhsPic;
