...
/**
 * <p>Java class for GetStatusByPicResponseType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="GetStatusByPicResponseType">
 *   &lt;complexContent>
...
@XmlType(name = "GetStatusByPicResponseType", propOrder = {
    "status"
})
public class GetStatusByPicResponseType
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetStatusByPicResponseType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GetStatusByPicResponseType that = ((GetStatusByPicResponseType) object);
        {
