...
/**
 * <p>Java class for GetBankAccountByPicResponseType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="GetBankAccountByPicResponseType">
 *   &lt;complexContent>
...
@XmlType(name = "GetBankAccountByPicResponseType", propOrder = {
    "bankAccount"
})
public class GetBankAccountByPicResponseType
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetBankAccountByPicResponseType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GetBankAccountByPicResponseType that = ((GetBankAccountByPicResponseType) object);
        {
