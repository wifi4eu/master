 ...
 * generated in the generated.jagate.model.coderef.V3 package. 
...
public class ObjectFactory {
    ...
    private final static QName _CodeRef_QNAME = new QName("http://ec.europa.eu/research/fp/model/code-ref/V3", "CodeRef");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: generated.jagate.model.coderef.V3
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ec.europa.eu/research/fp/model/code-ref/V3", name = "CodeRef")
