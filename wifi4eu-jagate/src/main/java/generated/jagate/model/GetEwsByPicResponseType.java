...
/**
 * <p>Java class for GetEwsByPicResponseType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="GetEwsByPicResponseType">
 *   &lt;complexContent>
...
@XmlType(name = "GetEwsByPicResponseType", propOrder = {
    "legalEntity"
})
public class GetEwsByPicResponseType
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetEwsByPicResponseType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GetEwsByPicResponseType that = ((GetEwsByPicResponseType) object);
        {
