...
/**
 * <p>Java class for GetBankAccountByFelIdRequestType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="GetBankAccountByFelIdRequestType">
 *   &lt;complexContent>
...
@XmlType(name = "GetBankAccountByFelIdRequestType", propOrder = {
    "felId"
})
public class GetBankAccountByFelIdRequestType
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetBankAccountByFelIdRequestType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GetBankAccountByFelIdRequestType that = ((GetBankAccountByFelIdRequestType) object);
        {
