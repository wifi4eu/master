...
/**
 * <p>Java class for UpdateLegalEntityRequestType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="UpdateLegalEntityRequestType">
 *   &lt;complexContent>
...
@XmlType(name = "UpdateLegalEntityRequestType", propOrder = {
...
public class UpdateLegalEntityRequestType
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof UpdateLegalEntityRequestType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final UpdateLegalEntityRequestType that = ((UpdateLegalEntityRequestType) object);
        {
