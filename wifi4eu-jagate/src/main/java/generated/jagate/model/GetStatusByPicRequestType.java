...
/**
 * <p>Java class for GetStatusByPicRequestType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="GetStatusByPicRequestType">
 *   &lt;complexContent>
...
@XmlType(name = "GetStatusByPicRequestType", propOrder = {
    "pic"
})
public class GetStatusByPicRequestType
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof GetStatusByPicRequestType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final GetStatusByPicRequestType that = ((GetStatusByPicRequestType) object);
        {
            List<String> lhsPic;
