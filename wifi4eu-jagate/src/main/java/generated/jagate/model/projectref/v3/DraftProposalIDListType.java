...
/**
 * <p>Java class for DraftProposalIDListType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="DraftProposalIDListType">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="ProposalID" type="{http://ec.europa.eu/research/fp/model/project-ref/V3}ProposalIdType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "DraftProposalIDListType", propOrder = {
    "proposalID"
})
public class DraftProposalIDListType
    implements Equals, HashCode, ToString
{

    @XmlElement(name = "ProposalID")
    protected List<ProposalIdType> proposalID;
     ...
     * 
     */
    public List<ProposalIdType> getProposalID() {
        if (proposalID == null) {
            proposalID = new ArrayList<ProposalIdType>();
        }
        return this.proposalID;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof DraftProposalIDListType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final DraftProposalIDListType that = ((DraftProposalIDListType) object);
        {
            List<ProposalIdType> lhsProposalID;
            lhsProposalID = (((this.proposalID!= null)&&(!this.proposalID.isEmpty()))?this.getProposalID():null);
            List<ProposalIdType> rhsProposalID;
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        {
            List<ProposalIdType> theProposalID;
