...
/**
 * <p>Java class for CreateLegalEntityResponseType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CreateLegalEntityResponseType">
 *   &lt;complexContent>
...
@XmlType(name = "CreateLegalEntityResponseType", propOrder = {
    "localObjectForeignId"
})
public class CreateLegalEntityResponseType
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CreateLegalEntityResponseType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CreateLegalEntityResponseType that = ((CreateLegalEntityResponseType) object);
        {
