...
/**
 * <p>Java class for BaseVisaType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="BaseVisaType">
 *   &lt;complexContent>
 *     &lt;extension base="{http://ec.europa.eu/rdg/jagate/ws/domain/base/v2}EmbebedBaseVisaType">
 *       &lt;sequence>
...
@XmlType(name = "BaseVisaType", propOrder = {
    "locObjForeignId"
})
public class BaseVisaType
    extends EmbebedBaseVisaType
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof BaseVisaType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final BaseVisaType that = ((BaseVisaType) object);
        {
