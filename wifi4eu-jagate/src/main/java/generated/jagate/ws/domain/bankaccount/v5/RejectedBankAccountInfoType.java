...
/**
 * <p>Java class for RejectedBankAccountInfoType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="RejectedBankAccountInfoType">
 *   &lt;complexContent>
...
@XmlType(name = "RejectedBankAccountInfoType", propOrder = {
    "freeTextReason"
})
public class RejectedBankAccountInfoType
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof RejectedBankAccountInfoType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final RejectedBankAccountInfoType that = ((RejectedBankAccountInfoType) object);
        {
