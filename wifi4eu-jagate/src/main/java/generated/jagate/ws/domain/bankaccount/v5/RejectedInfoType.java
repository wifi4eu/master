...
/**
 * <p>Java class for RejectedInfoType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="RejectedInfoType">
 *   &lt;complexContent>
...
@XmlType(name = "RejectedInfoType", propOrder = {
    "masterIdentifier",
    "freeTextReason"
})
public class RejectedInfoType
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof RejectedInfoType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final RejectedInfoType that = ((RejectedInfoType) object);
        {
