...
/**
 * <p>Java class for FollowUpBankAccountInfoType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="FollowUpBankAccountInfoType">
 *   &lt;complexContent>
...
@XmlType(name = "FollowUpBankAccountInfoType", propOrder = {
    "freeTextReason"
})
public class FollowUpBankAccountInfoType
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof FollowUpBankAccountInfoType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final FollowUpBankAccountInfoType that = ((FollowUpBankAccountInfoType) object);
        {
