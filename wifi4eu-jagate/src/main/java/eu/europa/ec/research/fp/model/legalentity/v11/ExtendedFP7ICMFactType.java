...
/**
 * <p>Java class for ExtendedFP7ICMFactType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ExtendedFP7ICMFactType">
 *   &lt;complexContent>
 *     &lt;extension base="{http://ec.europa.eu/research/fp/model/legalentity/V11}AbstractFactType">
 *       &lt;sequence>
 *         &lt;element name="Details" type="{http://ec.europa.eu/research/fp/model/legalentity/V11}FP7ICMFactType"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ExtendedFP7ICMFactType", propOrder = {
    "details"
})
public class ExtendedFP7ICMFactType
    extends AbstractFactType
    implements Equals, HashCode, ToString
{

    @XmlElement(name = "Details", required = true)
    protected FP7ICMFactType details;
     ...
     *     
     */
    public FP7ICMFactType getDetails() {
        return details;
    }
     ...
     *     
     */
    public void setDetails(FP7ICMFactType value) {
        this.details = value;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ExtendedFP7ICMFactType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final ExtendedFP7ICMFactType that = ((ExtendedFP7ICMFactType) object);
        {
            FP7ICMFactType lhsDetails;
            lhsDetails = this.getDetails();
            FP7ICMFactType rhsDetails;
