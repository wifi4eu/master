...
/**
 * <p>Java class for ExtendedRatiosFactType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ExtendedRatiosFactType">
 *   &lt;complexContent>
 *     &lt;extension base="{http://ec.europa.eu/research/fp/model/legalentity/V11}AbstractFactType">
 *       &lt;sequence>
 *         &lt;element name="Details" type="{http://ec.europa.eu/research/fp/model/legalentity/V11}RatiosFactType"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ExtendedRatiosFactType", propOrder = {
    "details"
})
public class ExtendedRatiosFactType
    extends AbstractFactType
    implements Equals, HashCode, ToString
{

    @XmlElement(name = "Details", required = true)
    protected RatiosFactType details;
     ...
     *     
     */
    public RatiosFactType getDetails() {
        return details;
    }
     ...
     *     
     */
    public void setDetails(RatiosFactType value) {
        this.details = value;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ExtendedRatiosFactType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final ExtendedRatiosFactType that = ((ExtendedRatiosFactType) object);
        {
            RatiosFactType lhsDetails;
            lhsDetails = this.getDetails();
            RatiosFactType rhsDetails;
