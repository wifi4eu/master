...
/**
 * <p>Java class for AccessibilityClassificationType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="AccessibilityClassificationType">
 *   &lt;complexContent>
...
@XmlType(name = "AccessibilityClassificationType", propOrder = {
    "action",
    "role"
})
public class AccessibilityClassificationType
    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof AccessibilityClassificationType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final AccessibilityClassificationType that = ((AccessibilityClassificationType) object);
        {
            String lhsAction;
