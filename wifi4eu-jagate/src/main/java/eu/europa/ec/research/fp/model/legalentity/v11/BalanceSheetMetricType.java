...
/**
 * <p>Java class for BalanceSheetMetricType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="BalanceSheetMetricType">
 *   &lt;complexContent>
...
@XmlType(name = "BalanceSheetMetricType", propOrder = {
    "value",
    "quote",
    "qualification"
})
public class BalanceSheetMetricType
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof BalanceSheetMetricType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final BalanceSheetMetricType that = ((BalanceSheetMetricType) object);
        {
            BigDecimal lhsValue;
