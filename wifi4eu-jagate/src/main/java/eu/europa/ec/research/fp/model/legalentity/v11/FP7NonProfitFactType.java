...
/**
 * <p>Java class for FP7NonProfitFactType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="FP7NonProfitFactType">
 *   &lt;complexContent>
...
@XmlType(name = "FP7NonProfitFactType", propOrder = {
    "nonProfit"
})
public class FP7NonProfitFactType
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof FP7NonProfitFactType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final FP7NonProfitFactType that = ((FP7NonProfitFactType) object);
        {
