...
/**
 * <p>Java class for ExtendedSMEFactType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="ExtendedSMEFactType">
 *   &lt;complexContent>
 *     &lt;extension base="{http://ec.europa.eu/research/fp/model/legalentity/V11}AbstractFactType">
 *       &lt;sequence>
 *         &lt;element name="Details" type="{http://ec.europa.eu/research/fp/model/legalentity/V11}SMEFactType"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "ExtendedSMEFactType", propOrder = {
    "details"
})
public class ExtendedSMEFactType
    extends AbstractFactType
    implements Equals, HashCode, ToString
{

    @XmlElement(name = "Details", required = true)
    protected SMEFactType details;
     ...
     *     
     */
    public void setDetails(SMEFactType value) {
        this.details = value;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof ExtendedSMEFactType)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final ExtendedSMEFactType that = ((ExtendedSMEFactType) object);
        {
            SMEFactType lhsDetails;
            lhsDetails = this.getDetails();
            SMEFactType rhsDetails;
