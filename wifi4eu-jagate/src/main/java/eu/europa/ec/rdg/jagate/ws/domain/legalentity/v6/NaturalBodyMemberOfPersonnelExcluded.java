...
/**
 * <p>Java class for NaturalBodyMemberOfPersonnelExcluded complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="NaturalBodyMemberOfPersonnelExcluded">
 *   &lt;complexContent>
...
@XmlType(name = "NaturalBodyMemberOfPersonnelExcluded", propOrder = {
    "countryIdentificationNumber",
    "vat",
    "birthData"
})
public class NaturalBodyMemberOfPersonnelExcluded
    ...
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof NaturalBodyMemberOfPersonnelExcluded)) {
            return false;
        }
        if (this == object) {
            return true;
        ...
        final NaturalBodyMemberOfPersonnelExcluded that = ((NaturalBodyMemberOfPersonnelExcluded) object);
        {
