...
/**
 * <p>Java class for FollowUpFelInfoType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="FollowUpFelInfoType">
 *   &lt;complexContent>
...
@XmlType(name = "FollowUpFelInfoType", propOrder = {
    "freeTextReason"
})
public class FollowUpFelInfoType
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof FollowUpFelInfoType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final FollowUpFelInfoType that = ((FollowUpFelInfoType) object);
        {
