...
import generated.jagate.ws.domain.base.v2.ScannedDocument;
...
/**
 * <p>Java class for LEScannedDocumentList complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="LEScannedDocumentList">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="ScannedDocument" type="{http://ec.europa.eu/rdg/jagate/ws/domain/base/v2}ScannedDocument" maxOccurs="3"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "LEScannedDocumentList", propOrder = {
    "scannedDocument"
})
public class LEScannedDocumentList
    implements Equals, HashCode, ToString
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof LEScannedDocumentList)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final LEScannedDocumentList that = ((LEScannedDocumentList) object);
        {
