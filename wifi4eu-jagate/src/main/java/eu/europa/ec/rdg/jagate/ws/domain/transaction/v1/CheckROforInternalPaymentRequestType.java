...
/**
 * <p>Java class for CheckROforInternalPaymentRequestType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="CheckROforInternalPaymentRequestType">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="localObjectForeigId" type="{http://www.w3.org/2001/XMLSchema}string"/>
 *         &lt;element name="recoveryOrderamount" type="{http://www.w3.org/2001/XMLSchema}decimal"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "CheckROforInternalPaymentRequestType", propOrder = {
    "localObjectForeigId",
    "recoveryOrderamount"
})
public class CheckROforInternalPaymentRequestType
    implements Equals, HashCode, ToString
{
    ...
    @XmlElement(required = true)
    protected BigDecimal recoveryOrderamount;
     ...
     *     
     */
    public BigDecimal getRecoveryOrderamount() {
     ...
     *     
     */
    public void setRecoveryOrderamount(BigDecimal value) {
        this.recoveryOrderamount = value;
    }

    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CheckROforInternalPaymentRequestType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CheckROforInternalPaymentRequestType that = ((CheckROforInternalPaymentRequestType) object);
        {
        ...
        {
            BigDecimal lhsRecoveryOrderamount;
            lhsRecoveryOrderamount = this.getRecoveryOrderamount();
            BigDecimal rhsRecoveryOrderamount;
            rhsRecoveryOrderamount = that.getRecoveryOrderamount();
    ...
    public StringBuilder appendFields(ObjectLocator locator, StringBuilder buffer, ToStringStrategy strategy) {
        ...
        {
            BigDecimal theRecoveryOrderamount;
            theRecoveryOrderamount = this.getRecoveryOrderamount();
