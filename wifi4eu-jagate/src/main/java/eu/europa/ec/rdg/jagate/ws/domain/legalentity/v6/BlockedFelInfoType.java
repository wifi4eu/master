...
/**
 * <p>Java class for BlockedFelInfoType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="BlockedFelInfoType">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="Code" type="{http://ec.europa.eu/rdg/jagate/ws/domain/legalentity/v6}BlockedReasonCodeType"/>
...
@XmlType(name = "BlockedFelInfoType", propOrder = {
    "code",
    "freeTextReason"
})
public class BlockedFelInfoType
    implements Equals, HashCode, ToString
{

    @XmlElement(name = "Code", required = true)
    protected String code;
    @XmlElement(name = "FreeTextReason")
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof BlockedFelInfoType)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final BlockedFelInfoType that = ((BlockedFelInfoType) object);
        {
            String lhsCode;
