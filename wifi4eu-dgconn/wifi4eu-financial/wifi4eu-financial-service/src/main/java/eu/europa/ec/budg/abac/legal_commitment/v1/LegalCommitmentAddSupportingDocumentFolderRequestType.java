...
/**
 * <p>Clase Java para LegalCommitmentAddSupportingDocumentFolderRequestType complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="LegalCommitmentAddSupportingDocumentFolderRequestType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "LegalCommitmentAddSupportingDocumentFolderRequestType", propOrder = {
    "localKey",
    "changeRequestReason",
    "supportingDocumentFolder"
})
public class LegalCommitmentAddSupportingDocumentFolderRequestType
