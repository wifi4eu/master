...
/**
 * <p>Clase Java para NaturalPersonCreateType complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="NaturalPersonCreateType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "NaturalPersonCreateType", propOrder = {
    "birthCountryCode",
    "birthDate",
    "driverLicense",
    "identityCard",
...
@XmlSeeAlso({
    StaffMemberCreateType.class,
    PrivatePersonCreateType.class
})
public abstract class NaturalPersonCreateType
