...
public class UserConstants {
     ...
     */
    public final static String MOCKED_USER_NAME = "Mr. Tester 5";
    public final static String MOCKED_MAIL = "tester5@test.com";
    public final static String MOCKED_DOMAIN = "TemporalDom";
    public final static DetailedUser MOCKED_DETAILED_USER = null;
    public final static String MOCKED_FIRST_NAME = "Tester Name 5";
    public final static String MOCKED_LAST_NAME = "Test LastName 5";
