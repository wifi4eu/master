...
public class SendNotificationsAsync implements Runnable {
    ...
    public SendNotificationsAsync(Integer callId, UserDTO userConnected) {
        ...
        this.voucherService = BeanUtil.getBean(VoucherService.class);
        this.applicationRepository = BeanUtil.getBean(ApplicationRepository.class);
        this.callService = BeanUtil.getBean(CallService.class);
        this.voucherAssignmentRepository = BeanUtil.getBean(VoucherAssignmentRepository.class);
        this.applicationMapper = BeanUtil.getBean(ApplicationMapper.class);
    ...
    public void run() {
        try {
            ...
            VoucherAssignmentAuxiliarDTO finalVoucherAssignment = voucherService.getVoucherAssignmentByCallAndStatus(callId, VoucherAssignmentStatus.FREEZE_LIST.getValue());
