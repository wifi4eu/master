...
import {VoucherManagementDTOBase} from "../../shared/swagger/model/VoucherManagementDTO";
...
export class DgConnPublicationComponent {
    ...
    private voucherManagements: VoucherManagementDTOBase[] = [];
    private voucherManagementsFirst: VoucherManagementDTOBase[] = [];
    private voucherManagementsSecond: VoucherManagementDTOBase[] = [];
