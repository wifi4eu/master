...
import {HelpdeskIssueDTOBase} from "../../shared/swagger/model/HelpdeskIssueDTO";
...
export class DgConnHelpdeskComponent {
    private issues: HelpdeskIssueDTOBase[];
    private selectedIssues: HelpdeskIssueDTOBase[];
    private issueSelected: HelpdeskIssueDTOBase;
    private display: boolean;
    private originalIssues: HelpdeskIssueDTOBase[];
    ...
    viewIssueDetails(issue: HelpdeskIssueDTOBase, rowIndex: number) {
