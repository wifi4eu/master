...
@Entity
public class BeneficiaryFinalListItem {
    ...
    public BeneficiaryFinalListItem() {
    }

    public BeneficiaryFinalListItem(Integer id, Integer lauId, String countryCode, Integer registrationId, String name, Integer status, Boolean verifiedToSign, Date dateSignature, Date dateCounterSignature) {
        this.id = id;
        this.lauId = lauId;
