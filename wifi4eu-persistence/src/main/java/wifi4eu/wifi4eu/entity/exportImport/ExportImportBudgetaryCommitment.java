...
public class ExportImportBudgetaryCommitment implements Serializable {
    ...
    public ExportImportBudgetaryCommitment(Integer id, String mun_OfficialName, String mun_OfficialAddress, String org_Name, String org_TypeCode, String sup_Name, String sup_BankAccount, Integer reg_RegistartionNumber, Integer app_VoucherAwarded, Integer app_BcStatus, Integer app_BcExport, Integer app_BcImport, Integer app_LefStatus, Integer app_LefExport, Integer app_LefImport) {
        this.id = id;
